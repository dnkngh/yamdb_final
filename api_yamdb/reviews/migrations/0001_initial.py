# Generated by Django 2.2.16 on 2022-05-07 07:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(error_messages={'validator': 'Оценка должна быть в диапазоне от 1 до 10'}, validators=[django.core.validators.MinValueValidator(1, message='Укажите значение от 1 до 10'), django.core.validators.MaxValueValidator(10, message='Укажите значение от 1 до 10')], verbose_name='Оценка произведения')),
